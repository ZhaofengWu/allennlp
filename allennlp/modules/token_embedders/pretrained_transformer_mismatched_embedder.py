...
class PretrainedTransformerMismatchedEmbedder(TokenEmbedder):
    ...
    def forward(
        ...
        token_ids: torch.LongTensor
            Shape: [..., num_wordpieces] (for exception see `PretrainedTransformerEmbedder`).
        mask: torch.LongTensor
            Shape: [..., num_orig_tokens].
        offsets: torch.LongTensor
            Shape: [..., num_orig_tokens, 2].
        ...
        Shape: [..., num_orig_tokens, embedding_size].
        """
        ...
        # span_embeddings: (..., num_orig_tokens, max_span_length, embedding_size)
        # span_mask: (..., num_orig_tokens, max_span_length)
